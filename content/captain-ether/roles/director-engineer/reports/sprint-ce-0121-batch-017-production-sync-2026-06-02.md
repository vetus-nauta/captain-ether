# CE-SPRINT-0121 Batch 017 Production Sync

Date: 2026-06-02
Owner: Director-Engineer
Scope: Captain Ether production sync after local M4 Batch 017 merge
Status: CLOSED / PASS / PRODUCTION_SYNCED

## Source State

```text
local/GitHub commit before deploy: b86d127
GitHub sync: 0 0
starter_items=625
...
FTP read-back before deploy showed production was still on Batch 016 baseline:
...
prod_batch017_marina_visible=false
```
...
```text
/game.brkovic.ltd/_deploy-backups/captain-ether/20260602T191025Z
```
...
```text
prod_starter_items=625
prod_grammar_patterns=214
prod_qa_items=625
prod_dangerous_pairs=146
prod_batch017_items_visible=true
prod_batch017_qa_visible=true
prod_batch017_grammar_visible=true
prod_batch017_dangerous_pairs_visible=6/6
```

Local corpus:

```text
local_starter_items=625
local_grammar_patterns=214
local_qa_items=625
local_dangerous_pairs=146
```
...
```text
local/GitHub/production are aligned for Captain Ether M4 Batch 017 narrow scope.
