# CE-SPRINT-0188 Batch 028 Production Sync

Date: 2026-06-03
Owner: Director-Engineer / QA
Scope: Captain Ether Batch 028 controlled production sync
Status: CLOSED / PASS / PRODUCTION_SYNCED

## Source State

```text
local/GitHub commit before deploy=cb781e7
starter_items=1000
...
secret_scan_false_positive_classification=token_variables_and_config_keys_only
```
...
reason=local/GitHub 1000 baseline passed post-merge QA and production was intentionally 30 items behind
```
...
```text
/game.brkovic.ltd/_deploy-backups/captain-ether/20260603T182651Z
```
...
starter_hash=a2a4865e15e6ed575d81533a85515821e2318be00c1397412b832ee2b4d31fb1
qa_hash_match=PASS
qa_hash=0e02ec67cfedfd70831322520d4eeb11752c489b311bed57c89a03b8074b74e6
prod_starter_items=1000
prod_grammar_patterns=581
prod_qa_items=1000
prod_dangerous_pairs=243
app.js_ftp_match=PASS hash=f7decab6bb90bc0b733f8171bc3c45aa7f4d5f0f8d9916582182412ab0e5b399
app.css_ftp_match=PASS hash=9f1f0e5acb7934cb6019745c72dceb4e4a4f622d83e1b20748b6d0f30b0de982
service-worker.js_ftp_match=PASS hash=5ac703505a5025e1e41f76dd2396313bb6c1e40f07f05669359e6b8686c8a7f1
manifest.webmanifest_ftp_match=PASS hash=20e1a441cc62b7b7b0d8efd53d2d4389cc51c10feacf4c9fb9e0a85f20f07184
```
...
Open and run release-readiness QA for the 1000-item Batch 028 production baseline.
